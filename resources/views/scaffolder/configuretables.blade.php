            ...
            <form method="POST" action="{{route("install.tablesConfigureP1")}}">
                <div class="row">
                    ...
                    @foreach($metadados as $nameTable=>$table)
                        ...
                        <div class="col-md-10 offset-1 ableToClose" id="{{$nameTable}}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="changecolor">
                                                    <button type="button" class="btn btn-sm btn-light"
                                                            onclick="configureClick({{$nameTable.$keyy}})"
                                                            id="{{$nameTable.$keyy}}_btn" data-toggle="modal"
                                                            data-target="#{{$nameTable.$keyy}}">Configure
                                                    </button>
                                                </td>
                                            </tr>

                                            <div class="modal fade" id="{{$nameTable.$keyy}}" tabindex="-1"
                                                 role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                                                 style="top: 20%; border-right: 20%;">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">{{$keyy}} -
                                                                Configuration</h5>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div id="{{$nameTable.$keyy}}_text"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Field
                                                                                Name</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="exampleInputEmail1">Lenght</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Show in
                                                                                project</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="exampleInputEmail1">Required</label>
                                                                            <input type="hidden" class="form-control"
                                                                    ...
                                                                    <div id="{{$nameTable.$keyy}}_select"
                                                                        ...
                                                                        <select class="form-control"
                                                                                ...
                                                                                onchange="changeSelectDiv(this,'{{$nameTable.$keyy}}')">
                                                                        ...
                                                                        <div class="selectDivHidden"
                                                                             id="{{$nameTable.$keyy}}_custom"
                                                                             style="display: none">
                                                                            <hr>

                                                                            <div
                                                                                class="{{$nameTable.$keyy}}_custom row">
                                                                            ...
                                                                            <a class="btn btn-sm btn-light"
                                                                               onclick='add({{$nameTable.$keyy}}_custom, "{{$nameTable}}", "{{$keyy}}")'>+</a>
                                                                        ...
                                                                        <div class="selectDivHidden"
                                                                             id="{{$nameTable.$keyy}}_relation"
                                                                             style="display: none">
                                                                            <hr>

                                                                            <label>Target Table</label>
                                                                            <select
                                                                                id="{{$nameTable.$keyy}}_relation_class"
                                                                                class="form-control"
                                                                                onchange="showTargetTableRel(this, '{{$nameTable.$keyy}}')"
                                                                                name="metadados[{{$nameTable}}][fields][{{$keyy}}][select][table]">
                                                                                @foreach($metadados as $nameTable1=>$table1)


                                                                                    <option
                                                                                        value="{{$nameTable1}}">{{$nameTable1}}</option>
                                                                            ...
                                                                            @foreach($metadados as $nameTable1=>$table1)
                                                                                <div
                                                                                    id="relation_{{$nameTable.$keyy.$nameTable1}}"
                                                                                    style="display: none;"
                                                                                    class="relation_target_hide">
                                                                                    <label>Foregein Key</label>
                                                                                    <select
                                                                                        name="metadados[{{$nameTable}}][fields][{{$keyy}}][select][foregein_key]"
                                                                                        class="form-control">
                                                                                        ...
                                                                                        @foreach($table1 as $keyy1=>$field1)
                                                                                            <option
                                                                                                value="{{$field1->Field}}">{{$field1->Field}}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            @endforeach
                                                                            ...
                                                                            @foreach($metadados as $nameTable1=>$table1)
                                                                                <div
                                                                                    id="relation_{{$nameTable.$keyy.$nameTable1}}_label"
                                                                                    style="display: none;"
                                                                                    class="relation_label_hide">
                                                                                    <label>Label to Show</label>

                                                                                    <select
                                                                                        name="metadados[{{$nameTable}}][fields][{{$keyy}}][select][label]"
                                                                                        class="form-control">
                                                                                        <option selected disabled>Select
                                                                                            One
                                                                                        </option>
